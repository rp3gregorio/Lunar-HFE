...
\vfill
{\color{dim} Companion to the science guidebook (\file{paper/primer/guidebook.tex})\\
...
statistics, read \file{paper/primer/guidebook.tex}; if you want a
...
\file{paper/primer/guidebook.tex}.}
