...
def main():
    ...
    # Cleanup 2026-07-06: only fig_f1_bug_schematic is still referenced by
    # the guidebook; the mcmc/bootstrap/aicc/numerical concept figures were
    # superseded by the TikZ flowcharts + real-data stats figures and are
    # kept in this file but not built.
